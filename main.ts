...
let usernames : string[] = ["Ali","Umair","Hashim","Admin","Razaq",]
usernames.forEach(greeting => {
    if (greeting == "Admin") {
        console.log(`Hello ${greeting}, Would you like to see status report ?`);
        
    }else{
    console.log(`Hello ${greeting} thank you for logging again.`);
    }
});