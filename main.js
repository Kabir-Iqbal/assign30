...
var usernames = ["Ali", "Umair", "Hashim", "Admin", "Razaq",];
usernames.forEach(function (greeting) {
    if (greeting == "Admin") {
        console.log("Hello ".concat(greeting, ", Would you like to see status report ?"));
    }
    else {
        console.log("Hello ".concat(greeting, " thank you for logging again."));
    }
});
